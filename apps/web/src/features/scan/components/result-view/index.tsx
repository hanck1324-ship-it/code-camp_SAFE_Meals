...
export function ScanResultScreen({
  ...
  // API 결과를 MenuItem 형식으로 변환
  const menuItems: MenuItem[] = scanData?.results
    ? scanData.results.map((result) => ({
        id: result.id,
        titleKey: result.translated_name,
        descKey: result.description,
        originalText: result.original_name,
        safetyStatus:
  ...
  return (
    <div className="flex h-screen flex-col bg-white">
      ...
      <div className="relative h-1/2">
        <img
          src={scanData?.capturedImage || 'https://images.unsplash.com/photo-1639508138725-0b8e762b3cfd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXN0YXVyYW50JTIwbWVudSUyMGZvb2R8ZW58MXx8fHwxNzY1NDkwNjYyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'}
          alt="Menu"
