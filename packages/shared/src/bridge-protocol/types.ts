...
export type NativeToWebMessage =
  ...
  | { type: 'CAMERA_IMAGE'; payload: { imageData: string; timestamp: number } } // 메뉴 촬영 이미지
...
export type WebToNativeMessage =
  ...
  | { type: 'SCAN_OCR'; payload?: never } // 메뉴 촬영 요청
  | { type: 'OPEN_CAMERA'; payload?: { mode?: 'barcode' | 'photo' } } // 카메라 열기
